...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import NLopt_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("079eb43e-fd8e-5478-9966-2cf3e3edb778"))
platforms = [Pkg.Artifacts.unpack_platform(e, "NLopt", artifacts_toml) for e in artifacts["NLopt"]]
...
if best_platform === nothing
    @debug("Unable to load NLopt; unsupported platform $(triplet(platform_key_abi()))")
else
